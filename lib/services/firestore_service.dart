...
class FirestoreService {
  ...
  Future<void> updateUserProfileImage(String userId, String imageUrl) async {
    ...
    await _db.collection('users').doc(userId).set({
      ...
      'photoUrl': imageUrl, // Synchronized for full compatibility with existing code
    ...
    final defaultProducts = [
      {
        ...
        'price': 89.99,
        'imageUrl': 'assets/images/men_shirt.png',
        'category': 'Men',
        'sizes': ['S', 'M', 'L', 'XL'],
      },
      {
        ...
        'price': 149.99,
        'imageUrl': 'assets/images/casual_jacket.png',
        'category': 'Men',
        'sizes': ['M', 'L', 'XL'],
      },
      {
        ...
        'price': 110.00,
        'imageUrl': 'assets/images/linen.png',
        'category': 'Pants',
        'sizes': ['S', 'M', 'L', 'XL'],
      },
      {
        ...
        'price': 45.00,
        'imageUrl': 'assets/images/silk_scarf.png',
      ...
      },
      {
        ...
        'price': 25.00,
        'imageUrl': 'assets/images/mens_tshirt.png',
        'category': 'Men',
        'sizes': ['S', 'M', 'L', 'XL', 'XXL'],
      },
      {
      ...
      },
      {
        ...
        'price': 39.99,
        'imageUrl': 'assets/images/summer_shirt.png',
        'category': 'Men',
        'sizes': ['S', 'M', 'L', 'XL'],
      },
      {
        ...
        'price': 129.99,
        'imageUrl': 'assets/images/classic_wool_coat.png',
        'category': 'Tops',
        'sizes': ['S', 'M', 'L', 'XL'],
      },
    ];
